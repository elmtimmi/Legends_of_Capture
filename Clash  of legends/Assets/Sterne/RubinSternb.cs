...
public class RubinSternb : MonoBehaviour {
    //Notizen
    // b4 300 0 300
    // -> a4 300 0 375
    ...
    void Update()
    {
        if (a.map == 1)
        {
            ...
            this.transform.position = new Vector3(380, 0, 224);
        }
...

        {
            ...
            this.transform.position = new Vector3(301, 0, 0);
...

        {
            ...
            this.transform.position = new Vector3(300, 0, 1220);
            this.transform.position = new Vector3(301, 0, -850);
        }
        /////////////////////////////////////////////////////////////////////////
        /// 
    }
